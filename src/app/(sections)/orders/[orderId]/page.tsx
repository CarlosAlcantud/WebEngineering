     ...
     <div className='flex flex-col '  >
      ...
      <div className="overflow-auto w-full">
        <div className="flex items-center pb-2">
          <strong className="flex-shrink-0 w-10">
        ...
        <div className="flex items-center pb-2">
          ...
          <div className="text-sm sm:text-base md:text-lg lg:text-xl" style={{ whiteSpace: 'nowrap' }}>
            <strong>Payment information:</strong> {order.cardNumber} ({order.cardHolder})
          </div>
        </div>

        <div className="pb-2 text-left text-sm sm:text-base md:text-lg lg:text-xl" style={{whiteSpace: 'nowrap',paddingRight: '45px'}}>
          <strong>
      ...
      <div className = "overflow-auto rounded-xl shadow-2xl mt-10">
        <table className = "w-full">
          <thead className='text-left bg-gray-50 border-b-2 border-gray-200'>
            <tr className='divide-y'>
              ...
              <th className='p-4 text-xs sm:text-sm md:text-base lg:text-lg w-20w-20/100 font-semibold text-center hidden sm:table-cell'>PRICE</th>
